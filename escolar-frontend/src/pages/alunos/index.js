...
function MainAluno(props) {
  ...
  function handleEdit(id) {
    window.location.href = `/escolas/${idescola}/turmas/${idturma}/alunos/editar/` + id;
  }
    ...
    <>
      ...
      <nav aria-label="breadcrumb">
        <ol className="breadcrumb">
          ...
          <li className="breadcrumb-item active" aria-current="page">alunos</li>
        </ol>
      </nav>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between' }}>
        ...
        <span style={{ paddingTop: 40 }} >
          <Link to={`/escolas/${idescola}/turmas/${idturma}/alunos/cadastrar`} className="btn btn-primary">
